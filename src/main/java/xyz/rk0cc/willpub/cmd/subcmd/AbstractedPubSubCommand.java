...
public sealed abstract class AbstractedPubSubCommand extends PubSubCommand permits PubDepsSubCommand, PubGetSubCommand, PubOutdatedSubCommand, PubPublishSubCommand {
